...
STOPLIST = stoplist = set('for a of the and to in an st is that are with by we as be this on from can which '
                          ...
                          'given there other but when then also been may its use any over their than same using used'
                          'more particular new given between first second figure shows shown since along '
